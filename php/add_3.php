...
$collection->update(array("cmd"=>"add3"),array('$set'=>array("srvId"=>$_POST["srvid"],"dpi"=>$_POST["dpi"],"des"=>$_POST["des"])));
...
$dpi->id = $info["id"];
	...
	//log
$collection = $dbc->List->cmd;
$collection->update(array("cmd"=>"add3"),array('$set'=>array("result"=>array("exCode"=>$temp->exInfo->exCode,"rstCode"=>$temp->rstCode))));
